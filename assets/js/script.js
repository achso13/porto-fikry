...
let options = {
    strings: ['UI/UX Design', 'Web Developer', 'Research', 'Photography', 'Nasi Goreng', 'Battle Royale Games', 'Sepedaan', 'Story Games', 'Videografi', 'Berdiskusi', 'Ide Kreatif dan Inovatif', 'Bola', 'Belajar Hal Baru'],
    typeSpeed: 30,
    backSpeed: 30,
    loop: true
};
